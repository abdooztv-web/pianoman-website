                ...
                >
                  ...
                  <div>
                    <p className="text-xs text-gray-400 uppercase tracking-wider mb-1">
                      {t.contact.contactItems[item.key]}
                    </p>
          ...
          <div>
            {submitted ? (
              <div className="h-full flex flex-col items-center justify-center text-center gap-6 py-20 border border-gray-100 px-8">
                ...
                <h3 className="text-2xl font-bold text-gray-900">{t.contact.success.heading}</h3>
                <p className="text-gray-600 max-w-xs">{t.contact.success.text}</p>
                <button
