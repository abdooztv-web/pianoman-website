...
const ar: typeof en = {
    ...
    items: [
      {
        ...
        title: "تأجير البيانو",
        description:
          "هل تبحث عن بيانو دون الالتزام الكامل؟ نقدم خطط تأجير مرنة للطلاب والفعاليات والمحترفين. من البيانو المستقيم إلى الجراند — الآلة المناسبة في اللحظة المناسبة.",
      ...
      },
      {
        ...
        title: "زيارات منزلية",
        description:
          "نحن نأتي إليك. يزور تقنيونا منزلك في جميع أنحاء القاهرة لضبط البيانو وتعديله وصيانته في راحة منزلك. بدون نقل. بدون متاعب.",
      ...
      },
      {
        ...
        title: "ترميم البيانو",
        description:
          "لكل بيانو قصة. نتخصص في إعادة الآلات القديمة والمهترئة إلى صوتها الكامل — من الإصلاحات الهيكلية إلى إعادة البناء الكاملة. بيانوك يستحق أفضل صوت.",
  ...
  restoration: {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: "يقوم حرفيونا بتفكيك البيانو بعناية، مع استبدال الأوتار البالية وإصلاح أو إعادة بناء آلية التشغيل ومعالجة أي أضرار هيكلية بدقة.",
      },
      {
        title: "الصوت والتشطيب",
        desc: "بمجرد أن يكون البيانو سليماً ميكانيكياً، نضبط صوته — نشكّل المطارق ونوازن النبرة عبر جميع المفاتيح الـ88 حتى تغني الآلة كما ينبغي.",
      },
      {
        title: "الضبط النهائي",
        desc: "ضبط دقيق للطبقة الموسيقية يضمن أن يكون بيانوك المُرمَّم جاهزاً للحفلات. لن نغادر حتى يصدر صوتاً مثالياً.",
      },
    ],
    quote:
      "رممنا أكثر من 1000 بيانو في جميع أنحاء القاهرة — من البيانو العتيق الذي عمره قرن إلى البيانو العائلي المحبوب الذي تناقلته الأجيال.",
  ...
  beforeAfter: {
    label: "عرض المشاريع",
    heading: "شيميل — إعادة بناء LED",
    description:
      "وصل بيانو شيميل المستقيم بدون إضاءة أمامية. قام فريقنا بتصميم وتركيب نظام LED مخصص من الصفر وأجرى ترميماً كاملاً.",
    swipeHint: "← مرر للاستكشاف",
    ctaText: "هل لديك بيانو يحتاج إلى ترميم؟ يسعدنا سماع قصته.",
    ctaBtn: "احصل على عرض سعر",
    steps: [
      { label: "قبل", caption: "وصل الشيميل بدون إضاءة أمامية" },
      { label: "أثناء العمل", caption: "شريط LED مصنوع يدوياً صممه وركّبه فريقنا" },
      { label: "بعد — الورشة", caption: "شيميل مع مصابيح خضراء فاخرة خرج حديثاً من الورشة" },
  ...
  about: {
    ...
    paras: [
      ...
      "من مقرنا في القاهرة، بنينا سمعتنا على سنوات من العمل اليدوي الدقيق — ضبط وترميم وتأجير البيانو للطلاب والمؤدين والعائلات في جميع أنحاء مصر.",
    ...
    promise: "احصل، أصلح، اعدل — هذا وعدنا.",
  },
  testimonials: {
    label: "آراء العملاء",
    ...
    items: [
      {
        ...
        text: "سلّم بيانو مان بيانو مستقيماً جميلاً إلى شقتي وعاد مرتين لضبطه. خدمة استثنائية — لم أضطر للقلق أبداً. كانت عملية الإيجار سلسة تماماً.",
      },
      {
        name: "أحمد ك.",
        role: "منتج موسيقى، المعادي",
        text: "كان لدي بيانو بيشتاين من أربعينيات القرن الماضي صامتاً تماماً. أمضى فريق ترميم بيانو مان ثلاثة أسابيع عليه والنتيجة فاقت كل توقعاتي. حرفية لا تُصدق.",
      },
      {
        name: "ليلى ن.",
        role: "منظمة فعاليات، مصر الجديدة",
        text: "احتجنا إلى بيانو جراند لحفل شركات في وقت قصير جداً. سلّم بيانو مان وثبّته وحتى ضبطه في الموقع. احترافي ودقيق وبسعر معقول.",
      },
    ],
  },
  contact: {
    label: "تواصل معنا",
    heading: "دعنا نتحدث عن بيانوك",
    subtext:
    ...
    form: {
      ...
      messagePlaceholder: "أخبرنا عن بيانوك وما تحتاجه...",
  ...
  blog: {
    ...
    moreIn: "المزيد في",
    ctaHeading: "هل أنت مستعد لمنح بيانوك الرعاية التي يستحقها؟",
  ...
  authorCard: {
    title: "المؤسس المشارك، بيانو مان مصر",
    bio: "متخصص بيانو في القاهرة. أدير بيانو مان مصر — تأجير وضبط وترميم.",
  },
};
